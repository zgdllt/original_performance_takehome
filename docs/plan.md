...
6. Continue the promoted 1102-cycle candidate toward the next target, below 1000 cycles, by reducing actual load/VALU/ALU work rather than only changing schedule order.
